...
namespace SimonsVoss.LSM.DB.Migrations
{
    ...
    [Migration("20220630191336_add_indexes_for_buildings_media_groups")]
    partial class add_indexes_for_buildings_media_groups
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimonsVoss.LSM.Core.Entities.SearchingWeight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("FullMatchMultiplier")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(10)
                        .HasColumnName("full_match_multiplier");
                    ...
                    b.Property<string>("TransitiveEntityName")
                        .HasColumnType("text")
                        .HasColumnName("transitive_entity_name");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_searching_weight");

                    b.ToTable("searching_weight", "public");
            ...
            modelBuilder.Entity("SimonsVoss.LSM.Core.Entities.Lock", b =>
                {
                    ...
                    b.HasOne("SimonsVoss.LSM.Core.Entities.Dictionaries.LockType", "LockType")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_locks_lock_types_lock_type_id");
            ...
            modelBuilder.Entity("SimonsVoss.LSM.Core.Entities.Medium", b =>
                {
                    ...
                    b.HasOne("SimonsVoss.LSM.Core.Entities.Dictionaries.MediumType", "MediumType")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_media_medium_types_medium_type_id");
